...
public class Atividade03App {

    private static final Logger log = LoggerFactory.getLogger(Atividade03App.class);

    private final Environment env;

    public Atividade03App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes Atividade03.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Atividade03App.class);
